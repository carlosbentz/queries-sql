...
INSERT INTO kopas (selecao, qnt_copas)
VALUES 
	('Brasil',5),
    ('Alemanha',5),
    ('Itália',4),
...
SET 
	qnt_copas = 4
WHERE selecao LIKE 'Ale%';

DELETE FROM 
	kopas
WHERE selecao LIKE 'Ja%';
...
INSERT INTO estadios (edicao,ano,estadio,"local",publico_pagante)
VALUES
    ...
    ('XI','2018','Estádio Lujniki','Moscou',78011);
